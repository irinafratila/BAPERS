...
String password = "TeaM27TeaM";
        try {
            ...
            while (result.next()){
                String staff1 = result.getString(1);
                String staff2 = result.getString(2);
                String staff3 = result.getString(3);
                String staff4 = result.getString(4);
                String staff5 = result.getString(5);
                System.out.println(staff1+ staff2 + staff3 + staff4 + staff5);
            }
